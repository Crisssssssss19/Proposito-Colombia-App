...
@Embeddable
public class RelUsuarioEmpresaId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        RelUsuarioEmpresaId entity = (RelUsuarioEmpresaId) o;
    ...
    public RelUsuarioEmpresaId(Integer idUsuario, Integer idEmpresa) {
        this.idUsuario = idUsuario;
        this.idEmpresa = idEmpresa;
    }
}