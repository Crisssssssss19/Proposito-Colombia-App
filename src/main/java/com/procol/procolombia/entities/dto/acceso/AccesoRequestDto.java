package com.procol.procolombia.entities.dto.acceso;

import java.io.Serializable;
import java.util.Objects;

/**
 * DTO for {@link com.procol.procolombia.entities.Acceso}
 */
public class AccesoRequestDto implements Serializable {
    ...
    public AccesoRequestDto(Integer idUsuario, String telefonoAcceso, String correoAcceso, String claveAcceso, String uuidAcceso, Integer usuarioIdUsuario) {
    ...
    public boolean equals(Object o) {
        ...
        AccesoRequestDto entity = (AccesoRequestDto) o;
